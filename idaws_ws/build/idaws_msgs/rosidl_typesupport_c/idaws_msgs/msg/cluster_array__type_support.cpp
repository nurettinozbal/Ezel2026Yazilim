...
static const _ClusterArray_type_support_symbol_names_t _ClusterArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, idaws_msgs, msg, ClusterArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, idaws_msgs, msg, ClusterArray)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, idaws_msgs, msg, ClusterArray)() {
  return &::idaws_msgs::msg::rosidl_typesupport_c::ClusterArray_message_type_support_handle;
}
