...
bool idaws_msgs__msg__buoy__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("idaws_msgs.msg._buoy.Buoy", full_classname_dest, 25) == 0);
  }
  idaws_msgs__msg__Buoy * ros_message = _ros_message;
  {  // label
...
{
  /* NOTE(esteve): Call constructor of Buoy */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("idaws_msgs.msg._buoy");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Buoy");
