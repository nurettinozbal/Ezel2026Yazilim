...
bool idaws_msgs__msg__cluster__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("idaws_msgs.msg._cluster.Cluster", full_classname_dest, 31) == 0);
  }
  idaws_msgs__msg__Cluster * ros_message = _ros_message;
  {  // id
  ...
  {  // point_count
    PyObject * field = PyObject_GetAttrString(_pymsg, "point_count");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->point_count = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
...
PyObject * idaws_msgs__msg__cluster__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("idaws_msgs.msg._cluster");
  ...
  {  // point_count
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->point_count);
    {
      int rc = PyObject_SetAttrString(_pymessage, "point_count", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
