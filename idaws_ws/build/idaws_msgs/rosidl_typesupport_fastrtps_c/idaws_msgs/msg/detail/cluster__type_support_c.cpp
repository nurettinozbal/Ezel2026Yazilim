...
#include "idaws_msgs/msg/detail/cluster__rosidl_typesupport_fastrtps_c.h"
...
using _Cluster__ros_msg_type = idaws_msgs__msg__Cluster;
...
static uint32_t _Cluster__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_idaws_msgs__msg__Cluster(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = idaws_msgs__msg__Cluster;
    is_plain =
      (
...
static size_t _Cluster__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_idaws_msgs__msg__Cluster(
