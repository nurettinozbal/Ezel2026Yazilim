...
#include "idaws_msgs/msg/detail/buoy__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = idaws_msgs::msg::Buoy;
    is_plain =
      (
...
static bool _Buoy__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  auto typed_message =
    static_cast<const idaws_msgs::msg::Buoy *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}

static bool _Buoy__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  auto typed_message =
    static_cast<idaws_msgs::msg::Buoy *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Buoy__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const idaws_msgs::msg::Buoy *>(
...
static size_t _Buoy__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_Buoy(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Buoy__callbacks = {
  "idaws_msgs::msg",
  "Buoy",
  _Buoy__cdr_serialize,
  _Buoy__cdr_deserialize,
  _Buoy__get_serialized_size,
  _Buoy__max_serialized_size
};

static rosidl_message_type_support_t _Buoy__handle = {
...
get_message_type_support_handle<idaws_msgs::msg::Buoy>()
{
  return &idaws_msgs::msg::typesupport_fastrtps_cpp::_Buoy__handle;
}
