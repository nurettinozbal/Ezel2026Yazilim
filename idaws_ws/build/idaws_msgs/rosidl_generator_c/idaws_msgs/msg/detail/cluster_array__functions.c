...
idaws_msgs__msg__ClusterArray__init(idaws_msgs__msg__ClusterArray * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    idaws_msgs__msg__ClusterArray__fini(msg);
    return false;
  }
  // clusters
  if (!idaws_msgs__msg__Cluster__Sequence__init(&msg->clusters, 0)) {
    idaws_msgs__msg__ClusterArray__fini(msg);
    return false;
  }
  return true;
...
idaws_msgs__msg__ClusterArray__fini(idaws_msgs__msg__ClusterArray * msg)
{
  ...
  // clusters
  idaws_msgs__msg__Cluster__Sequence__fini(&msg->clusters);
}
...
idaws_msgs__msg__ClusterArray__are_equal(const idaws_msgs__msg__ClusterArray * lhs, const idaws_msgs__msg__ClusterArray * rhs)
{
  ...
  // clusters
  if (!idaws_msgs__msg__Cluster__Sequence__are_equal(
  ...
  idaws_msgs__msg__ClusterArray * output)
{
  ...
  // clusters
  if (!idaws_msgs__msg__Cluster__Sequence__copy(
...
idaws_msgs__msg__ClusterArray__create()
{
  ...
  idaws_msgs__msg__ClusterArray * msg = (idaws_msgs__msg__ClusterArray *)allocator.allocate(sizeof(idaws_msgs__msg__ClusterArray), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(idaws_msgs__msg__ClusterArray));
  bool success = idaws_msgs__msg__ClusterArray__init(msg);
  if (!success) {
...
idaws_msgs__msg__ClusterArray__Sequence__init(idaws_msgs__msg__ClusterArray__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  idaws_msgs__msg__ClusterArray * data = NULL;

  if (size) {
    data = (idaws_msgs__msg__ClusterArray *)allocator.zero_allocate(size, sizeof(idaws_msgs__msg__ClusterArray), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = idaws_msgs__msg__ClusterArray__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        idaws_msgs__msg__ClusterArray__fini(&data[i - 1]);
      }
...
idaws_msgs__msg__ClusterArray__Sequence__fini(idaws_msgs__msg__ClusterArray__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      idaws_msgs__msg__ClusterArray__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  idaws_msgs__msg__ClusterArray__Sequence * array = (idaws_msgs__msg__ClusterArray__Sequence *)allocator.allocate(sizeof(idaws_msgs__msg__ClusterArray__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = idaws_msgs__msg__ClusterArray__Sequence__init(array, size);
  if (!success) {
...
idaws_msgs__msg__ClusterArray__Sequence__destroy(idaws_msgs__msg__ClusterArray__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    idaws_msgs__msg__ClusterArray__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
idaws_msgs__msg__ClusterArray__Sequence__are_equal(const idaws_msgs__msg__ClusterArray__Sequence * lhs, const idaws_msgs__msg__ClusterArray__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!idaws_msgs__msg__ClusterArray__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  idaws_msgs__msg__ClusterArray__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(idaws_msgs__msg__ClusterArray);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    idaws_msgs__msg__ClusterArray * data =
      (idaws_msgs__msg__ClusterArray *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!idaws_msgs__msg__ClusterArray__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          idaws_msgs__msg__ClusterArray__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!idaws_msgs__msg__ClusterArray__copy(
