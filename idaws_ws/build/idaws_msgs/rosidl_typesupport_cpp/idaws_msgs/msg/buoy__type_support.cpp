...
static const _Buoy_type_support_symbol_names_t _Buoy_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, idaws_msgs, msg, Buoy)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, idaws_msgs, msg, Buoy)),
  }
};
...
{
  return &::idaws_msgs::msg::rosidl_typesupport_cpp::Buoy_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, idaws_msgs, msg, Buoy)() {
  return get_message_type_support_handle<idaws_msgs::msg::Buoy>();
}
