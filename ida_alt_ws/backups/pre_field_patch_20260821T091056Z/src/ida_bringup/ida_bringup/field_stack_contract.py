...
FIELD_TUNING_PARAMETERS = {
    "ida_autonomy": (
        ...
        "p3_search_yaw_rate_deg_s", "p3_search_rotations_per_cycle",
        "p3_search_initial_hold_s", "p3_staging_advance_s", "p3_staging_speed_mps",
        "p3_staging_arrival_m", "p3_lock_confirm_s",
