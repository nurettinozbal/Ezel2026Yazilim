...
export IDA_FIELD_PROFILE_PATH="${IDA_FIELD_PROFILE_PATH:-$IDA_WS/src/ida_bringup/config/field_profile.yaml}"
[[ -f "$IDA_FIELD_PROFILE_PATH" ]] || {
  echo "RED: tek saha profili bulunamadi: $IDA_FIELD_PROFILE_PATH" >&2
  exit 4
}
