...
from ida_planning.dwa import DEFAULT_W, DwaCommand, DwaPlanner, _wrap_rad, build_offset_cells
...
class TestTargetEngagement(unittest.TestCase):
    ...
    def test_field_engagement_and_lock_respect_effective_speed_floor(self):
        ...
        self.assertEqual(lock.vx, 0.0)
        self.assertIn("target_align", lock.action)
    ...
    def test_target_must_align_before_approach_and_keeps_yaw_while_engaging(self):
        ...
        self.assertIn("target_align", off_center.action)
        self.assertEqual(off_center.vx, 0.0)
