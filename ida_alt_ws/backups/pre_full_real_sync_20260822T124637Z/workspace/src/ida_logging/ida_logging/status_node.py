...
``active`` yalnızca CSV'de veri satırı, haritada JSON satırı ve MP4 ile
``frames.csv`` içinde gerçek kare kanıtı varsa true olur. ``files`` panelde yol
göstermek için hazır tutulur; şimdilik
