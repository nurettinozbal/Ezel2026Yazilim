...
FIELD_TUNING_PARAMETERS = {
    "ida_autonomy": (
        ...
        "p2_exit_advance_speed_mps", "p2_exit_align_latch_release_deg",
        "p3_lock_confirm_s",
        "p3_lock_confirm_frames", "p3_target_loss_grace_s",
        "p3_target_memory_timeout_s",
        ...
        "p2_costmap_inflation_speed_cap_mps",
        "near_field_stop_m",
        "near_field_slow_m", "near_field_stop_lateral_m",
        "near_field_slow_lateral_m",
        "near_field_pivot_yaw_deg_s", "near_field_slow_speed_mps",
        "near_field_stop_release_m", "p3_near_field_stop_m",
        "p3_near_field_stop_release_m", "near_field_escape_trigger_s",
        ...
        "corridor_goal_lateral_gain", "p2_route_corridor_enabled",
        "p2_route_corridor_lookahead_m", "p2_route_corridor_half_width_m",
        "p2_route_corridor_confidence", "safety_base_m", "safety_max_m",
    ...
    "ida_map_logger": ("log_hz", "segment_duration_s", "flush_every_lines"),
